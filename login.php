...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, username, password FROM login WHERE username='$input_username' OR email='$input_username'";
...
<section class="login-area pt-100 pb-100">
    <div class="container">
        <div class="login-wrap text-center">
            <h3 class="title">وارد حساب کاربری خود شوید</h3>
            <a href="#" class="google-login"><img src="assets/img/icon/google.png" alt="google">با گوگل وارد شوید</a>
            <span class="or-text">یا</span>
            <form action="" method="POST" class="login-form">
                <div class="form-item">
                    <h4 class="form-header">نام کاربری یا آدرس ایمیل</h4>
                ...
                <div class="submit-btn">
                    <button type="submit" class="rr-primary-btn">ورود به حساب کاربری</button>
                </div>
                <a href="#" class="forgot">رمز عبور خود را گم کرده اید؟</a>
            </form>
            <div class="response">
